...
blankrow<-label_data[1,]

range1<-1:nblock
range2<-nblock+(1:nblock)
range3<-nblock+range2
plotdata<-rbind(label_data[range1,],label_data[1,],label_data[range2,],label_data[1,],label_data[range3,],label_data[1,])
myrows<-c(range2[1],range3[1],nrow(plotdata))
for (k in myrows){
