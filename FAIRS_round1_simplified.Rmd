...
For quantitative ratings like these, agreement was computed as the proportion of individuals in a group endorsing the most popular option for that group, and flagged when one option was selected by at least `r mycutoff <- .8; mycutoff` of the group. As there were only 3 options, no chunking of responses was done for this item. 

*There was no combination of group/response that achieved the `r mycutoff` level of agreement*. 
...
**Agreement**: .  For this item, over 80% sleuths endorse response C, whereas far fewer do so in the other groups. 
...
**Agreement**: A 3-point scale was used to compute agreement, with 1-2 collapsed and 4-5 collapsed.   80% agreement was achieved for subitem A (research consumers) by group R, and for subitem B, where harm to other researchers was rated as high by all groups. 
...
**Agreement**: The only cases of 80% agreement are for option A, group R, and option D groups R and O, where over 80% gave highest ranking (4)
...
**Agreement**: Here 80% of group S agreed that a low probability of being detected/reported had a large impact, whereas 80% of group R and group O gave highest rating to "publish or perish" culture. 
...
**Agreement**:  For all groups, the overall trend is to endorse this statement, but support is markedly stronger for Sleuths.  If we collapse A+B, then, sleuths have 96% agreement. 
...
**Agreement**: Group S is keener on what may be seen as the more negative consequences for severe research misconduct; 80% endorsement for C and D (collapsed to 3 point scale).  They are less keen on options A and B - but there's less agreement there.
