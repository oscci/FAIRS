...
thisf <- "R2_responses_29.csv"

df <- read.csv(thisf)
myjisc <- read.csv('R2_survey_template.csv')
mypanel <- read.csv('From_MS_Forms copy.csv')
...
myft <- flextable(as.data.frame(text))
...
`r  propagree(2,df,mycutoff,respmax=5,thisrow)`  
...
`r  propagree(9,df,mycutoff,respmax=4,thisrow,jisccodes)` 
