...
For this item, agreement was computed simply as the proportion of individuals in a group endorsing the most popular option for that group. This table shows any response options that exceeded `r mycutoff <- .8; mycutoff` agreement. 
...
(NB For all items rated on a 5-point scale, when computing agreement, a 3-point scale is used, with 1-2 collapsed and 4-5 collapsed).
